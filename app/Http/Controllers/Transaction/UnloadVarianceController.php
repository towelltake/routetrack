...
class UnloadVarianceController extends Controller
{
    private const LINE_TYPE = 9;
    ...
    public function index(Request $request): Response
    {
        ...
        if (!Schema::hasTable('inventorytransactionheader') || !Schema::hasTable('inventorytransactiondetail')) {
            return Inertia::render('transaction/unload-variance/Index', [
        ...
        $query = DB::table('inventorytransactionheader as header')
            ...
            ->whereExists(function ($subQuery) {
                ...
                if (Schema::hasColumn('inventorytransactiondetail', 'transactiontypecode')) {
                    $subQuery->where('detail.transactiontypecode', self::LINE_TYPE);
                }
            });
        ...
        if (Schema::hasColumn('inventorytransactionheader', 'transactiontype')) {
            $query->where('header.transactiontype', 3);
        }
    ...
    public function show(Request $request, int $detailkey): Response
    {
        ...
        if (Schema::hasColumn('inventorytransactiondetail', 'transactiontypecode')) {
            $lineQuery->where('detail.transactiontypecode', self::LINE_TYPE);
        }
        ...
        return Inertia::render('transaction/unload-variance/Show', [
            'header' => [
