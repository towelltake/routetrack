...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $formId = DB::table('moduledetail')
            ->whereRaw('LOWER(TRIM(formname)) = ?', ['account customer channel'])
            ->value('formid');
        ...
        if (!$formId) {
            DB::table('moduledetail')->insert([
                'formname' => 'Account Customer Channel',
                'formdescription' => 'Manage account customer channels',
        ...
        if (Schema::hasTable('usertypedetail')) {
            ...
            foreach ($typeRows as $row) {
                ...
                $payload['formname'] = 'Account Customer Channel';
                $payload['formdescription'] = 'Manage account customer channels';
