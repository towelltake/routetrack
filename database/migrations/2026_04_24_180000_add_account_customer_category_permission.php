    ...
    public function up(): void
    {
        ...
        if (!$formId) {
            DB::table('moduledetail')->insert([
                'formname' => 'Account Customer Category',
                'formdescription' => 'Manage account customer categories',
        ...
        if (Schema::hasTable('usertypedetail')) {
            ...
            foreach ($typeRows as $row) {
                ...
                $payload['formname'] = 'Account Customer Category';
                $payload['formdescription'] = 'Manage account customer categories';
