...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($source) {
            ...
            $payload['formname'] = 'Account Tax';
            $payload['formdescription'] = 'Manage customer and item tax codes';
        ...
        DB::table('moduledetail')->insert([
            'formid' => $nextFormId,
            'moduleid' => $moduleId,
            'formname' => 'Account Tax',
            'formdescription' => 'Manage customer and item tax codes',
            'order' => $nextFormId,
        ]);
    }
