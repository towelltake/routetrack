...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $description = 'Manage route item groups';
        ...
        if (!$existing) {
            ...
            $payload['formname'] = 'Route Item Group';
            $payload['formdescription'] = $description;
            $payload['order'] = $nextOrder;

            DB::table('moduledetail')->insert($payload);
            $this->syncPermissionRows('userdetail', 'userid', (int) $source->formid, $nextFormId, $moduleId, 'Route Item Group', $description);
            $this->syncPermissionRows('usertypedetail', 'usertypeid', (int) $source->formid, $nextFormId, $moduleId, 'Route Item Group', $description);
    ...
    public function down(): void
    {
        ...
        DB::table('moduledetail')
            ...
            ->update([
                'moduleid' => $moduleId,
                'formdescription' => 'Assign route item groups to routes',
            ]);
