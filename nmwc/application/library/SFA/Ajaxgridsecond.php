    ...
    public function create_data_grid($data_row_display)
    {
        ...
        for($s=0; $s<count($data_row_display); $s++)
        {
            ...
            if($this->configuration_params['show_deletelink'])
            {
                ...
                //$deletelink = '<a href="Javascript:void(0)" id="'.$this->url().'" id2="del_'.$data_row_display[$s]['edit_del_primary_id'].'" redirecturl="'.$baseurl.$deletelink.'" class="icodel" >Delete</a>';
