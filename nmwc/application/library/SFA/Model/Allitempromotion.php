...
class SFA_Model_Allitempromotion extends Zend_Db_Table_Abstract
{
	   ...
	   foreach($result as $value)
		...
		if(!empty($range_arr))
		{
		    ...
		    $insert_query ="INSERT INTO promotiondetail_temp
				   ...
				   SELECT ".$data['route_key'].",".$data['visit_key'].",".$data['transactionkey'].",1, invoicedetail_temp.itemcode,0,
				   (((salesqty / itemmaster.unitspercase)  *
					    (invoicedetail_temp.salescaseprice)) +
					    ((salesqty % itemmaster.unitspercase)  * invoicedetail_temp.salesprice)) AS promoamount, 
    ...
    */
	...
	$select  ="    SELECT  IF(sales_amount = '0.0000', FORMAT(((salesqty / itemmaster.unitspercase) *
			...
			invoicedetail_temp.itemcode, IFNULL(invoicedetail_temp.salesqty,0) AS SalesQty
