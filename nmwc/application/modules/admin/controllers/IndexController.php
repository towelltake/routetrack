    ...
    public function indexAction()
    {
       ...
       if(count($formdata) > 0 )
	   {
           //An array for add/edit values of setup page
            ...
            $param_array[2]   =  (!empty($formdata["txtconvrate"]) ? $formdata["txtconvrate"] : 0);  //$formdata["txtconvrate"];  // conversionrate
            ...
            $param_array[7]   =  0;//$formdata["ddlweekstday"];  // weekstartday
            ...
            $param_array[18]  =  (!empty($formdata["ddlconvtload"]) ? $formdata["ddlconvtload"] : 0);  //$formdata["ddlconvtload"];  // enableloadrequesttoloadout
            $param_array[19]  =  (!empty($formdata["chkresfileday"]) ? 1 : 0); // restrictprepareile
            $param_array[20]  =  (!empty($formdata["ddlmultidaypost"]) ? $formdata["ddlmultidaypost"] : 0);  //$formdata["ddlmultidaypost"];  // multidaypostingdate
			...
			$param_array[23]  =  ($formdata["ddltablet_synmode"] ==2) ? $formdata['txttimeinterval'] : 0 ; // tabletsyncmode			
