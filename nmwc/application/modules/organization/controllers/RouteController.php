...
class Organization_RouteController extends Organization_Library_Controller_Action_Abstract
{
    ...
    */
    ...
    {	
		...
		$cols_array = array('route.routecode','route.routename','salesman.salesmancode','salesman.salesmanname1','subarea.subareaname','route.device_assigned_id','route.activestatus');
    ...
    */
    public function addrouteAction()
    {
		...
		if($formdata['hdnid'] > 0){
			...
			$param_array[6] = date('Y-m-d');//$formdata[''];			//mdat
			...
			$param_array[12] = ($formdata['txtdt_time'] <> ""?$formdata['txtdt_time'] :0);//$formdata['txtdt_time'];		//passwordarray01
			$param_array[13] = ($formdata['txtpr_chng'] <> ""?$formdata['txtpr_chng'] :0);//$formdata['txtpr_chng'];		//passwordarray02
			$param_array[14] = ($formdata['txtpromo_ovr'] <> ""?$formdata['txtpromo_ovr'] :0);//$formdata['txtpromo_ovr'];		//passwordarray03
			$param_array[15] = ($formdata['txtrt_setup'] <> ""?$formdata['txtrt_setup'] :0);//$formdata['txtrt_setup'];		//passwordarray04
			$param_array[16] = ($formdata['txttel_setup'] <> ""?$formdata['txttel_setup'] :0);//$formdata['txttel_setup'];		//passwordarray05
			$param_array[17] = ($formdata['txtload_adj'] <> ""?$formdata['txtload_adj'] :0);//$formdata['txtload_adj'];		//passwordarray06
			$param_array[18] = ($formdata['txtst_day'] <> ""?$formdata['txtst_day'] :0);//$formdata['txtst_day'];		//passwordarray07
			$param_array[19] = ($formdata['txtapp_exit'] <> ""?$formdata['txtapp_exit'] :0);//$formdata['txtapp_exit'];		//passwordarray08
			$param_array[20] = ($formdata['txtsettl'] <> ""?$formdata['txtsettl'] :0);//$formdata['txtsettl'];		//passwordarray09
			$param_array[21] = ($formdata['txtload_sec'] <> ""?$formdata['txtload_sec'] :0);//$formdata['txtload_sec'];		//passwordarray10
			$param_array[22] = ($formdata['txtunload'] <> ""?$formdata['txtunload'] :0);//$formdata['txtunload'];		//passwordarray11
			$param_array[23] = ($formdata['txtload_out'] <> ""?$formdata['txtload_out'] :0);//$formdata['txtload_out'];		//passwordarray12
			$param_array[24] = ($formdata['txtprnt_doc'] <> ""?$formdata['txtprnt_doc'] :0);//$formdata['txtprnt_doc'];		//passwordarray13
			$param_array[25] = ($formdata['txtload_trans'] <> ""?$formdata['txtload_trans'] :0);//$formdata['txtload_trans'];		//passwordarray14
			$param_array[26] = ($formdata['txtload_req'] <> ""?$formdata['txtload_req'] :0);//$formdata['txtload_req'];		//passwordarray15
			$param_array[27] = ($formdata['txtload_req'] <> ""?$formdata['txtload_req'] :0);//$formdata['txtnewreq'];		//passwordarray16
			$param_array[28] = ($formdata['chkdepot_route']<>""?$formdata['chkdepot_route']:0);		//deliveryroute
			$param_array[29] = ($formdata['chkallow_chng']<>""?$formdata['chkallow_chng']:0);		//presalesorder
			...
			$param_array[36] = ($formdata['chkallow_route_startday'] <> ""?$formdata['chkallow_route_startday'] :0);//$formdata['chkallow_route_startday']; //cmpycode
			$param_array[37] = $formdata['txtcode'];		//Routecode
			$param_array[38] = $formdata['device_assigned'];//($formdata['device_assigned'] <> ""?$formdata['device_assigned'] :0);
			$param_array[39] = ($formdata['ddlitemmustkey']<> ""?$formdata['ddlitemmustkey']:0);
			...
			if($result[0][0]['result'] == 'duplicate'){
				...
				//echo "tesddddddd";
					...
					$param_setting1_array[6]=($formdata['ddlloadreqreportformat']<>""?$formdata['ddlloadreqreportformat']:0);//$formdata['ddlloadreqreportformat']; // loadreqreportformat
					$param_setting1_array[7]=($formdata['ddlautocalculateloadin']<>""?$formdata['ddlautocalculateloadin']:0);//$formdata['ddlautocalculateloadin']; // autocalculateloadin
					$param_setting1_array[8]=($formdata['ddlrequireloadin']<>""?$formdata['ddlrequireloadin']:0);//$formdata['ddlrequireloadin']; // requireloadin
					$param_setting1_array[9]=($formdata['ddlloadsheetreport']<>""?$formdata['ddlloadsheetreport']:0);//$formdata['ddlloadsheetreport']; // loadsheetreport
					$param_setting1_array[10]=($formdata['ddlamountdecimaldigits']<>""?$formdata['ddlamountdecimaldigits']:0);//$formdata['ddlamountdecimaldigits']; // amountdecimaldigits
					$param_setting1_array[11]=($formdata['ddlitemcodedisplay']<>""?$formdata['ddlitemcodedisplay']:0);//$formdata['ddlitemcodedisplay']; // itemcodedisplay
					$param_setting1_array[12]=($formdata['ddlusealternatecodes']<>""?$formdata['ddlusealternatecodes']:0);//$formdata['ddlusealternatecodes']; // usealternatecodes
					$param_setting1_array[13]=($formdata['ddlrouteitemgrpcode']<>""?$formdata['ddlrouteitemgrpcode']:0);//$formdata['ddlrouteitemgrpcode']; // routeitemgrpcode
					$param_setting1_array[14]=0; // 
					$param_setting1_array[15]=($formdata['ddlitemdescriptiondisplay']<>""?$formdata['ddlitemdescriptiondisplay']:0);//$formdata['ddlitemdescriptiondisplay']; // itemdescriptiondisplay
					$param_setting1_array[16]=($formdata['ddlenableloadtransfer']<>""?$formdata['ddlenableloadtransfer']:0);//$formdata['ddlenableloadtransfer']; // enableloadtransfer
					$param_setting1_array[17]=($formdata['ddlenablescanneruse']<>""?$formdata['ddlenablescanneruse']:0);//$formdata['ddlenablescanneruse']; // enablescanneruse
					$param_setting1_array[18]=($formdata['chkenableeodaddchecks']<>""?$formdata['chkenableeodaddchecks']:0);//$formdata['chkenableeodaddchecks']; // enableeodaddchecks
					$param_setting1_array[19]=($formdata['chkenabledelayprint']<>""?$formdata['chkenabledelayprint']:0);//$formdata['chkenabledelayprint']; // enabledelayprint
					$param_setting1_array[20]=($formdata['chkenableaddcustomer']<>""?$formdata['chkenableaddcustomer']:0);//$formdata['chkenableaddcustomer']; // enableaddcustomer
					$param_setting1_array[21]=0;// 
					$param_setting1_array[22]=($formdata['chkenforcecallsequence']<>""?$formdata['chkenforcecallsequence']:0);//$formdata['chkenforcecallsequence']; // enforcecallsequence
					$param_setting1_array[23]=($formdata['chkenablefoclimit']<>""?$formdata['chkenablefoclimit']:0);//$formdata['chkenablefoclimit']; // enablefoclimit
					$param_setting1_array[24]=($formdata['chkenablescancustomer']<>""?$formdata['chkenablescancustomer']:0);//$formdata['chkenablescancustomer']; // enablescancustomer
					$param_setting1_array[25]=($formdata['chkloadoutadjustments']<>""?$formdata['chkloadoutadjustments']:0);//$formdata['chkloadoutadjustments']; // loadoutadjustments
					$param_setting1_array[26]=($formdata['chkenableeodexpenses']<>""?$formdata['chkenableeodexpenses']:0);//$formdata['chkenableeodexpenses']; // enableeodexpenses
					$param_setting1_array[27]=($formdata['chkenablecashonlydiscount']<>""?$formdata['chkenablecashonlydiscount']:0);//$formdata['chkenablecashonlydiscount']; // enablecashonlydiscount
					$param_setting1_array[28]=($formdata['chkenablepostvoid']<>""?$formdata['chkenablepostvoid']:0);//$formdata['chkenablepostvoid']; // enablepostvoid
					$param_setting1_array[29]=($formdata['chkenableeodadjchecks']<>""?$formdata['chkenableeodadjchecks']:0);//$formdata['chkenableeodadjchecks']; // enableeodadjchecks
					$param_setting1_array[30]=($formdata['chkspe_inv_seq']<>""?$formdata['chkspe_inv_seq']:0);//$formdata['chkspe_inv_seq']; // transactionnoseq
					$param_setting1_array[31]=($formdata['chkenablefreereason']<>""?$formdata['chkenablefreereason']:0);//$formdata['chkenablefreereason']; // enablefreereason
					$param_setting1_array[32]=$this->currentUser->username;
					$param_setting1_array[33]= ($formdata['ddlprint_alternate']<>""?$formdata['ddlprint_alternate']:0);//$formdata['ddlprint_alternate'];					//inventoryreportcontrol				
					$param_setting1_array[34]= ($formdata['chkroute_weekday']<>""?$formdata['chkroute_weekday']:0);//$formdata['chkroute_weekday'];					//enablestartdayrtewkdayedit
					$param_setting1_array[35]= ($formdata['chkstartdaydate']<>""?$formdata['chkstartdaydate']:0);//$formdata['chkstartdaydate'];					//enablestartdaydatetimeedit
					$param_setting1_array[36]= ($formdata['chkrouteunloadvariance']<>""?$formdata['chkrouteunloadvariance']:0);//$formdatchkrouteunloadvariancea[''];		//enablestartdaydatetimeedit
					$param_setting1_array[37]= ($formdata['chkrouteunloadvariance']<>""?$formdata['chkrouteunloadvariance']:0);//$formdata['ddlsalesmantargetdays'];			//salesmantargetdays
					$param_setting1_array[38]= ($formdata['chkvoidoverride']<>""?$formdata['chkvoidoverride']:0);//$formdata['chkvoidoverride'];					//voidoverride
					//echo "tssdf0550";
				...
				//	echo "tssdfddddd056";
					...
					$param_setting2_array[7]=($formdata['ddldisplayinvsummary']<> ""?$formdata['ddldisplayinvsummary']:0); // displayinvsummary
					...
					$param_setting2_array[10]=($formdata['ddldepotprinter']<>""?$formdata['ddldepotprinter']:0); // depotprinter
					$param_setting2_array[11]=($formdata['ddllockstatus']<>""?$formdata['ddllockstatus']:0); // lockstatus
					...
					$param_setting2_array[17]=($formdata['chkenablemiddaytelecom']<>""?$formdata['chkenablemiddaytelecom']:0); // enablemiddaytelecom
					$param_setting2_array[18]=($formdata['chkallowroutestartdayflag']<>""?$formdata['chkallowroutestartdayflag']:0); // allowroutestartdayflag
					$param_setting2_array[19]=($formdata['chkallowgctocash']<>""?$formdata['chkallowgctocash']:0); // allowgctocash
					$param_setting2_array[20]=($formdata['chkenablerouteweekday']<>""?$formdata['chkenablerouteweekday']:0); // enablerouteweekday
					$param_setting2_array[21]=($formdata['chkenabledraftcopy']<>""?$formdata['chkenabledraftcopy']:0); // enabledraftcopy
					$param_setting2_array[22]=($formdata['cdcvaliditydays']<>""?$formdata['cdcvaliditydays']:0); // cdcvaliditydays
					...
					$param_setting2_array[33]= ($formdata['chkenableautopostingaccount']<>""?$formdata['chkenableautopostingaccount']:0); // enableautopostingaccount
					...
					$param_setting2_array[35] = ($formdata['tx_forcesettlementdays']<>""?$formdata['tx_forcesettlementdays']:0);
					$param_setting2_array[36] = ($formdata['chk_routecredit']<>""?$formdata['chk_routecredit']:0);
					$param_setting2_array[37] = ($formdata['routecreditlimitdays']<>""?$formdata['routecreditlimitdays']:0);
					
					/*for edit New param added by nilesh on 31Mar2016*/
					$param_setting2_array[38]=($formdata['chkupd_gps']<>""?$formdata['chkupd_gps']:0);			//updategps
					$param_setting2_array[39]=($formdata['chkenforce_gps'] <>""?$formdata['chkenforce_gps']:0);		//enforcegps
					$param_setting2_array[40]=($formdata['chkenable_gps'] <>""?$formdata['chkenable_gps']:0);       //enablegps
