    ...
    */
    public function addqualificationgrpAction()
    {
		...
		if($params['id'] > 0){
			...
			$param_array[9] = (trim($formdata["txtquantity"])>0?trim($formdata["txtquantity"]):0); //promocaseprice
    ...
    */
    public function qualificationgrpitemgridAction()
    {
		...
		if($formdata["add"]=="yes") {
			...
			$param_array[7] = '0';					//promopcprice
			$param_array[8] = '0';					//promocaseprice
			$param_array[9] = (trim($formdata["txtquantity"])>0?trim($formdata["txtquantity"]):0); 
