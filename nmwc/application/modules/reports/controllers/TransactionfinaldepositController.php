...
*/
class Reports_TransactionfinaldepositController extends Reports_Library_Controller_Action_Abstract
{
     /**f
    * @name       init
    * @since      01-10-2012
    ...
    */
    ...
    public function finaldepositAction()
    {
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = $this->translate->_("Final Deposit");
    ...
    public function collectionsumAction()
    {
        ...
        $result_arr = $this->SFA_Comman->executequery('CALL sp_report_transaction_finaldeposit(?,?,?,?,?)',$param_array,'');
    ...
    */
    public function exportAction()
    {
        ...
        for($i = 0; $i < count($result_arr[1]); $i++)
        {
            ...
            $column_model_arr[$result_arr[1][$i]['routecode']." - ".$routename][$result_arr[1][$i]['documentnumber']][] = array($result_arr[1][$i]['transactiondate'],
                                        $result_arr[1][$i]['customercode']." - ".$customername, $result_arr[1][$i]['arcash'], $result_arr[1][$i]['archeck'], $result_arr[1][$i]['totalinvoiceamount'],
                                        $result_arr[1][$i]['alternateinvoicenumber'], $result_arr[1][$i]['invoicedby'], $result_arr[1][$i]['invoicedate'], $result_arr[1][$i]['amountpaid']);
        }
        ...
        $data_arr["config"]["file_name"]    = "Final Deposit";
