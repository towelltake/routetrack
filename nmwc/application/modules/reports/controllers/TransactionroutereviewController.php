...
class Reports_TransactionroutereviewController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = $this->translate->_("Route Visit Review");
    ...
    */
    public function exportAction()
    {
        ...
        {
			$routename 		= ($this->css == 'ar_') ? $result_arr[1][$i]['arbroutename'] 	: $result_arr[1][$i]['route'];
			
            $column_model_arr[$routename][] = array($result_arr[1][$i]['routestartdate1'],$result_arr[1][$i]['daytxt'],$result_arr[1][$i]['routeenddate1'],$result_arr[1][$i]['targettovisit'],$result_arr[1][$i]['targetvisits'],$result_arr[1][$i]['callexceptions'],$result_arr[1][$i]['nontargetvisits'],$result_arr[1][$i]['totalvisits'],$result_arr[1][$i]['schedulesale'],$result_arr[1][$i]['schedulenosale'],$result_arr[1][$i]['unschedsale'],$result_arr[1][$i]['unschedulenosale'],$result_arr[1][$i]['effectivevisit'],$result_arr[1][$i]['startkms'],$result_arr[1][$i]['endkms'],$result_arr[1][$i]['kmscovered']);
        }
