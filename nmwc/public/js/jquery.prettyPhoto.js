...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			gallery_markup: '<div class="pp_gallery111" style="display:none"> \
								<a href="#" class="pp_arrow_previous11">Previous</a> \
								<div> \
									<ul> \
										{gallery} \
									</ul> \
								</div> \
								<a href="#" class="pp_arrow_next11">Next</a> \
							</div>',
		...
		*/
		$.prettyPhoto.open = function(event) {
			...
			if(pp_descriptions[set_position] != ""){				
				// Commented and inserted by MB[mayur.b@elantechnologies.com]
				// Because it was displayed undefined in popup box
