...
<div></div>
	...
	<tr><td align="right">Override For :-</td><td><select name="type" id="type" align="right">
	...
	<tr><td align="right">CustomerCode :-</td><td><input align="right" type="text" value="<?php echo $_POST['customercode'];?>" name="customercode" id="customercode" required></td></tr>
