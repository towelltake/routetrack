...
const pageTitle = computed(() =>
  isCreate.value ? t.create_salesman_message : isView.value ? t.view_salesman_message : t.edit_salesman_message,
);
...
function submit() {
  ...
  if (isCreate.value) {
    form.post("/account/salesman-message");
    return;
  }

  form.put(`/account/salesman-message/${form.messagekey}`);
}
...
<template>
  ...
  <BasePageHeading
    :title="pageTitle"
    :subtitle="t.salesman_message_note"
  >
    <template #extra>
      <div class="d-flex gap-2">
        <button class="btn btn-alt-secondary" @click="router.get('/account/salesman-message')">
          <i class="fa fa-arrow-left me-1"></i> {{ t.back }}
        </button>
        <button v-if="isView" class="btn btn-primary" @click="router.get(`/account/salesman-message/${form.messagekey}/edit`)">
    ...
    <BaseBlock>
      <div class="row g-4 mb-3">
        ...
        <div class="col-md-5">
          ...
          <input v-model="form.messagedescription" class="form-control" :readonly="isView" :required="!isView" />
          <div v-if="form.errors.messagedescription" class="text-danger fs-sm mt-1">{{ form.errors.messagedescription }}</div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-6">
          ...
          <input v-model="form.message1" class="form-control" :readonly="isView" />
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input v-model="form.message2" class="form-control" :readonly="isView" />
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input v-model="form.message3" class="form-control" :readonly="isView" />
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input v-model="form.message4" class="form-control" :readonly="isView" />
        </div>
        <div class="col-md-6">
