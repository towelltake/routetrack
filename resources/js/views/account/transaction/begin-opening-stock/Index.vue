...
function reloadList(pageNumber = 1) {
  router.get("/transaction/begin-opening-stock", {
...
function detailUrl(detailkey) {
  ...
  return `/transaction/begin-opening-stock/${detailkey}?${params.toString()}`;
}
</script>
          ...
          <thead>
            <tr>
              <th class="cursor-pointer" @click="sort('routecode')">
                {{ t.route_code }}<i class="fa ms-1" :class="sortIcon('routecode')"></i>
              </th>
              <th class="cursor-pointer" @click="sort('salesmanname1')">
                {{ t.salesman }}<i class="fa ms-1" :class="sortIcon('salesmanname1')"></i>
              </th>
              <th class="cursor-pointer" @click="sort('routename')">
                {{ t.route_name }}<i class="fa ms-1" :class="sortIcon('routename')"></i>
              </th>
              <th class="cursor-pointer" @click="sort('documentnumber')">
                {{ t.document_no }}<i class="fa ms-1" :class="sortIcon('documentnumber')"></i>
              </th>
              <th class="cursor-pointer" @click="sort('transactiontime')">
                {{ t.transaction_time }}<i class="fa ms-1" :class="sortIcon('transactiontime')"></i>
              </th>
