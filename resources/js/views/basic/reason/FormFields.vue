...
<template>
  <div class="modal-body row g-3">
    <div class="col-md-6">
      <label class="form-label">{{ t.reason_type }} <span class="text-danger">*</span></label>
      <select
        v-model="form.type"
        class="form-select"
    ...
    <div class="col-md-6">
      ...
      <input
        v-model="form.arbdescription"
        class="form-control"
        :class="{ 'is-invalid': form.errors.arbdescription }"
        dir="rtl"
        maxlength="100"
        :readonly="isViewing"
      />
      <div class="invalid-feedback">{{ form.errors.arbdescription }}</div>
    </div>
  </div>
</template>
