...
async function onSubmit() {
  ...
  // Go to dashboard
  router.get("/preview/backend/pages/auth");
}
</script>

<template>
  <Head title="Sign In 3" />
    ...
    <div class="row g-0 bg-primary-dark-op">
      ...
      >
        <div class="p-4 p-xl-5 flex-grow-1 d-flex align-items-center">
          <div class="w-100">
            <Link href="/preview" class="link-fx fw-semibold fs-2 text-white">
      ...
      >
        <div class="p-3 w-100 d-lg-none text-center">
          <Link href="/preview" class="link-fx fw-semibold fs-3 text-dark">
            One<span class="fw-normal">UI</span>
          </Link>
        </div>
          ...
          <div class="w-100">
            ...
            <div class="text-center mb-5">
              ...
              <p class="fw-medium text-muted">
                ...
                <Link href="/preview/auth/signup3">sign up</Link>
                for a new account.
              </p>
            </div>
            <!-- END Header -->
