      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
          <li class="breadcrumb-item">
            <Link
              href="/preview/backend/page-packs/elearning/courses"
              class="link-fx"
              >Courses</Link
            >
          </li>
          ...
          <table class="table table-borderless table-vcenter">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <Link
                    href="/preview/backend/page-packs/elearning/lesson"
                    class="fw-medium"
                    >1.1 HTML5 Intro (free preview)</Link
                  >
                </td>
