  ...
  <div class="content content-boxed">
    <div class="row items-push py-4">
      ...
      <div class="col-md-6 col-lg-4 col-xl-3">
        <BaseBlock
          href="/preview/backend/page-packs/elearning/course"
          tag="Link"
          link-pop
          class="h-100 mb-0"
        >
        ...
        >
          <template #content>
            <div class="block-content block-content-full text-center bg-smooth">
              ...
              <div class="fs-sm text-white-75">18 lessons &bull; 25 hours</div>
            </div>
            <div class="block-content block-content-full">
              <h4 class="h5 mb-1">
        ...
        >
          <template #content>
            ...
            >
              ...
              <div class="fs-sm text-white-75">21 lessons &bull; 29 hours</div>
            </div>
            <div class="block-content block-content-full">
