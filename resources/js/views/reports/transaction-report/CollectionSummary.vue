...
function reload(page = 1) {
  router.get("/reports/transaction-report/collection-summary", currentParams(page), {
    preserveScroll: true,
    preserveState: true,
    replace: true,
...
function exportUrl(type) {
  ...
  return `/reports/transaction-report/collection-summary/export/${type}?${params.toString()}`;
}
...
<template>
  <Head title="Collection Summary" />

  <BasePageHeading
    title="Collection Summary"
    subtitle="Review route-wise receipt collections, cash, cheque, and invoice references for the selected period."
  />
  ...
  <div class="content">
    ...
    <BaseBlock title="Collection Summary Report">
      <template #options>
