...
function reload(page = 1) {
  router.get("/reports/transaction-report/order-summary", currentParams(page), {
    preserveScroll: true,
    preserveState: true,
    replace: true,
...
function exportUrl(type) {
  ...
  return `/reports/transaction-report/order-summary/export/${type}?${params.toString()}`;
}
...
<template>
  ...
  <BasePageHeading
    title="Order Summary"
    subtitle="Review route-wise order transactions and order net amounts by transaction date."
  />
  ...
  <div class="content">
    ...
    <BaseBlock title="Order Summary Report">
      <template #options>
        ...
        <table class="table table-bordered table-striped table-vcenter fs-sm">
          <thead>
            <tr>
              ...
              <th class="cursor-pointer text-nowrap" @click="sort('transactiondate_sort')">Tran. Date <i class="fa ms-1" :class="sortIcon('transactiondate_sort')"></i></th>
              <th class="cursor-pointer text-nowrap" @click="sort('transactiontime_sort')">Tran. Time <i class="fa ms-1" :class="sortIcon('transactiontime_sort')"></i></th>
              <th class="cursor-pointer text-nowrap" @click="sort('invoicenumber_sort')">Order Number <i class="fa ms-1" :class="sortIcon('invoicenumber_sort')"></i></th>
              <th class="cursor-pointer text-nowrap" @click="sort('receivedtime_sort')">Received Time <i class="fa ms-1" :class="sortIcon('receivedtime_sort')"></i></th>
              ...
              <th class="cursor-pointer text-nowrap text-end" @click="sort('invoiceamount')">Order Net Amount <i class="fa ms-1" :class="sortIcon('invoiceamount')"></i></th>
            </tr>
          </thead>
          <tbody>
