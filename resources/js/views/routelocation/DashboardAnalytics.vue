            ...
            <div class="analytics-table-scroll" tabindex="0" aria-label="Scrollable performance comparison">
                <table><thead><tr>
                    ...
                    <tr v-for="group in visibleGroups" :key="group.id">
                        ...
                        <td>{{ percent(group.productive, group.completed) }}<small>{{ group.productive }} / {{ group.completed }} visits</small><small>Collection: {{ percent(group.collection_productive, group.completed) }}</small><small>Orders/Invoices: {{ percent(group.sales_order_productive, group.completed) }}</small></td>
