        ...
        <div class="route-status-body">
            ...
            <template v-else>
                ...
                <section>
                    ...
                    <div v-if="filteredRows.length > 50" class="d-flex gap-2 align-items-center mt-2">
                        <button :disabled="page <= 1" @click="page--">Previous</button>
                        <span>{{ page }} / {{ Math.ceil(filteredRows.length / 50) }}</span>
                        <button :disabled="page * 50 >= filteredRows.length" @click="page++">Next</button>
                    </div>
                </section>
            </template>
        </div>
...
h3 { margin: 18px 0; font-size: 15px; }
