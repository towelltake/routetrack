...
<head>
    ...
    <title>Deposit Summary Report</title>
    <style>
    ...
    <table class="report-table">
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="text-end">{{ number_format((float) $row['total'], $amountPrecision) }}</td>
                </tr>
            @empty
                <tr>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-end">{{ number_format((float) $totals['total'], $amountPrecision) }}</td>
            </tr>
        </tfoot>
    </table>
</body>
