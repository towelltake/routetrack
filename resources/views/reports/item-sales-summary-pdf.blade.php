    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th>Sales Qty</th>
                <th>Free Qty</th>
                <th>Damage Ret. Qty</th>
                <th>Expired Qty</th>
                <th>Good Ret. Qty</th>
                <th>Sales @ Std. Price</th>
                <th>Sales @ Inv. Price</th>
                <th>Damage Ret @ Std. Price</th>
                <th>Damage Ret @ Inv. Price</th>
                <th>Expired Ret @ Std. Price</th>
                <th>Expired Ret @ Inv. Price</th>
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="text-end">{{ number_format((float) ($row['damage_std_price'] ?? 0), $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) ($row['damage_inv_price'] ?? 0), $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) ($row['expired_std_price'] ?? 0), $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) ($row['expired_inv_price'] ?? 0), $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) ($row['good_return_std_price'] ?? 0), $amountPrecision) }}</td>
                    ...
                    <td class="text-end">{{ number_format((float) ($row['net_sales'] ?? 0), $amountPrecision) }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-end">{{ number_format((float) ($totals['damage_std_price'] ?? 0), $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) ($totals['damage_inv_price'] ?? 0), $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) ($totals['expired_std_price'] ?? 0), $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) ($totals['expired_inv_price'] ?? 0), $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) ($totals['good_return_std_price'] ?? 0), $amountPrecision) }}</td>
                ...
                <td class="text-end">{{ number_format((float) ($totals['net_sales'] ?? 0), $amountPrecision) }}</td>
