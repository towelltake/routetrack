    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th>Immediate CASH Payment</th>
                <th>Immediate Cheque Payment</th>
                <th>AR CASH Collection</th>
                <th>AR Cheque Collection</th>
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td class="text-end">{{ number_format((float) $row['immediatecash'], $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) $row['immediatecheck'], $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) $row['arcash'], $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) $row['archeck'], $amountPrecision) }}</td>
                    <td class="text-end">{{ number_format((float) $row['outstandingbalanceamount'], $amountPrecision) }}</td>
                </tr>
            @empty
                <tr>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-end">{{ number_format((float) $totals['immediatecash'], $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) $totals['immediatecheck'], $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) $totals['arcash'], $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) $totals['archeck'], $amountPrecision) }}</td>
                <td class="text-end">{{ number_format((float) $totals['outstandingbalanceamount'], $amountPrecision) }}</td>
            </tr>
        </tfoot>
    </table>
</body>
