...
<head>
    ...
    <title>Route Deposit Summary Report</title>
    <style>
    ...
    <table class="report-table">
        ...
        <tbody>
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td>{{ $row['drawdate'] ?: '-' }}</td>
                    <td class="text-end">{{ number_format((float) $row['amount'], $amountPrecision) }}</td>
                </tr>
            @empty
                <tr>
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-end">{{ number_format((float) $totals['amount'], $amountPrecision) }}</td>
            </tr>
        </tfoot>
    </table>
</body>
